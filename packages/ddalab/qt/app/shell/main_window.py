...
from ...backend.contracts import BackendClient
...
from ..analysis.main_window_analysis import MainWindowAnalysisMixin
from ..core.navigation import PRIMARY_SECTIONS, SECONDARY_SECTIONS
from ..integrations.main_window_integrations import MainWindowIntegrationsMixin
from ..support.main_window_support import MainWindowSupportMixin
from ..visualization.main_window_visualize import MainWindowVisualizeMixin
...
class MainWindow(
    ...
    secondary_sections: Dict[str, List[str]] = {
        section: list(labels) for section, labels in SECONDARY_SECTIONS.items()
    }
    ...
    def __init__(
        ...
        self.backend: BackendClient = LocalBackendClient(runtime_paths)

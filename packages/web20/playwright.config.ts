...
export default defineConfig({
  ...
  use: {
    ...
    /* Extra browser context options to handle test environment issues */
    contextOptions: {
      /* Disable web security to handle SSL cert issues in test environment */
      ignoreHTTPSErrors: true,
    },
    
    /* Additional launch options for better test environment stability */
    launchOptions: {
      args: [

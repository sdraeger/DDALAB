        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-700 dark:text-gray-300 max-w-2xl mx-auto">
              A powerful desktop application for performing scientific analysis
              on EDF and ASCII files using advanced delay differential
              algorithms.
            </p>
          </div>
          ...
          <div className="space-y-8 mb-12">
            ...
            {isTauri && <EmbeddedApiManager onApiReady={handleApiReady} />}
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Load and analyze EDF and ASCII files with comprehensive
                  metadata extraction
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Advanced delay differential analysis with multiple algorithm
                  variants
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Interactive plots and real-time data visualization
                  capabilities
                </CardDescription>
              </CardHeader>
            </Card>

...
from server.core.database import UserPreferences as UserPreferencesDB
from server.core.dependencies import get_service
from server.core.services import UserPreferencesService

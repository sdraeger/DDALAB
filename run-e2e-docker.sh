...
# Script to run ConfigManager e2e tests in a simple Docker container

set -e

echo "========================================"
echo "ConfigManager E2E Test Runner (Docker)"
echo "========================================"
...
if docker-compose -f docker-compose.e2e-simple.yml up --build --exit-code-from e2e-tests; then
...
docker-compose -f docker-compose.e2e-simple.yml down
